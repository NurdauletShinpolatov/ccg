...
function getMenuPositionClassName(element) {
    ...
    var isBottomOverflow = rect.bottom > window.innerHeight;
...
var Dropdown = function (_a) {
    ...
    return (React.createElement("div", { className: clsx('rnd', className), ref: containerRef },
        ...
        dropdownIsOpen && (React.createElement("ul", { className: "rnd__root-menu rnd__menu ".concat(menuPositionClassName), style: { width: containerWidth }, ref: rootMenuRef }, items.map(function (item, index) { return (React.createElement(Option, { key: index, option: item, onSelect: handleSelect, renderOption: renderOption })); })))));
};
